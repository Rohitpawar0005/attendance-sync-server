# Generated by Django 6.0.3 on 2026-03-10 08:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_year', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='api.academicyear')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('classes', models.ManyToManyField(blank=True, to='api.schoolclass')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_year', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.academicyear')),
                ('school_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendance_records', to='api.schoolclass')),
